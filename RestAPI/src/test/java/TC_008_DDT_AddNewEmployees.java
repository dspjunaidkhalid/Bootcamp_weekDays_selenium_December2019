...
public class TC_008_DDT_AddNewEmployees {
    @Test
    void postNewEmployees(){
        ...
        requestParams.put("name", "JunaidKhalid");
        ...
        Assert.assertEquals(responseBody.contains("JunaidKhalid"), true);
        Assert.assertEquals(responseBody.contains("545"), true);
