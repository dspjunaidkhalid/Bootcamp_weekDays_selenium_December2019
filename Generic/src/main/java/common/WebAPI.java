    ...
    public WebDriver getLocalDriver(   @Optional("mac")    String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("mac")) {
                System.setProperty("webdriver.chrome.driver", "/Users/junaidkhalid/IdeaProjects/Bootcamp_weekDays_selenium_December2019/Generic/BrowserDriver/mac/chromedriver");
